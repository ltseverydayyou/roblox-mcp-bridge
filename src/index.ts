...
const server = new McpServer(
  ...
  },
  {
    instructions: [
      ...
      "8. Call get-executor-capabilities before relying on executor-specific APIs. Heavy executor enumeration is on-demand only; none of getgc/getnilinstances/getconnections/getloadedmodules/registry scans or Cobalt remote spying run merely because the bridge connected.",
